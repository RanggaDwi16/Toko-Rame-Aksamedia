...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/document-copy.svg
  SvgGenImage get documentCopy =>
      const SvgGenImage('assets/icons/document-copy.svg');

  /// File path: assets/icons/import.svg
  SvgGenImage get import => const SvgGenImage('assets/icons/import.svg');

  /// File path: assets/icons/new-tage.svg
  SvgGenImage get newTage => const SvgGenImage('assets/icons/new-tage.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/detail_product.png
  AssetGenImage get detailProduct =>
      const AssetGenImage('assets/images/detail_product.png');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [detailProduct, slide1, slide2, slide3];
}
